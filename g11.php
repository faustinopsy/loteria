...
echo "<div class='modal-dialog'>Resutado 11 Pontos Garantidos
...
$q15=0;
		   for($i =1; $i <= $total; $i++){ 
			$busca1=$conn->query("select  B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14,B15 from taloes11 where n= $i");
