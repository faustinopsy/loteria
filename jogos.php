...
echo "<div class='modal-dialog'>Meus Jogos
...
$cmd = "SELECT * FROM jogo where user= '".$id_user."'";
$tal = $conn->query($cmd);
...
$q15=0;
		   ...
		   for($i =1; $i <= $total; $i++){ 
		    $numeros=mysqli_fetch_array($tal);
  
			$busca1=$conn->query("select  n1,n2, n3, n4, n5, n6, n7, n8,n9,n10,n11,n12,n13,n14,n15 from jogo where id= '".$numeros['id']."'");
			
		   $resul=mysqli_fetch_array($busca1);
		   $talao = array_unique($resul);
...
foreach ($talao as $t){
	...
	echo "<b><input type='button'   readonly  value=$check | ></b>"; 
}
$t=sizeof($talao); 
echo " Acertos ",$q;
if($q==11)
